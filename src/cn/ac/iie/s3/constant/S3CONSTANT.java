...
public class S3CONSTANT {
	...
	public static final String _DIGEST_FOLDER = "digest";
	public static final String _SHARD_FOLDER = "shard";
	public static final String _STORE_FOLDER = "storeFile";
	public static final String _RECYCLE_FOLDER = "recycleFolder";
	public static final String _TRASH_FOLDER = "trash";
